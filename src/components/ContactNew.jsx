              ...
              <form onSubmit={handleSendMessage}>
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    className="w-full px-0 py-3 border-0 border-b-2 border-gray-200 focus:border-orange-400 focus:ring-0 resize-none bg-transparent"
                    rows="4"
                    placeholder=""
                    required
                  ></textarea>
                ...
                <button
                  type="submit"
                  className="w-full bg-orange-400 text-white py-3 rounded-full hover:bg-orange-500 transition-all duration-300 font-medium"
                >
                  Send Message
                </button>
              </form>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <button
                    ...
                    className="text-orange-400 hover:text-orange-500 transition-colors duration-300 font-medium"
                  >
                    Request
                  </button>
                </div>
